...
JACK_STL_LDFLAGS_64 := -Lprebuilts//ndk/current/sources/cxx-stl/gnu-libstdc++/4.9/libs/arm64-v8a -lgnustl_static
JACK_STL_INCLUDES_64 := $(JACK_ROOT)/android/cxx-stl/gnu-libstdc++/libs/arm64-v8a/include \
...
LOCAL_CFLAGS := $(common_cflags) -DSERVER_SIDE
LOCAL_CPPFLAGS := $(common_cppflags)
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS_64)
LOCAL_C_INCLUDES := $(common_c_includes_64)
LOCAL_SHARED_LIBRARIES := libc libdl libcutils libutils libjackshm
LOCAL_MODULE_TAGS := eng optional
LOCAL_MODULE := libjackserver
ifeq ($(SUPPORT_ANDROID_REALTIME_SCHED), true)
...
# ========================================================
# in.so - sapaproxy internal client 64bit
# ========================================================
include $(CLEAR_VARS)
...
# ========================================================
# out.so - sapaproxy internal client 64bit
# ========================================================
include $(CLEAR_VARS)
...
LOCAL_LDFLAGS := $(JACK_STL_LDFLAGS_64)  -ldl -Wl,--no-fatal-warnings
LOCAL_C_INCLUDES := $(common_c_includes_64)
else
...
LOCAL_CPPFLAGS := $(common_cppflags)
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS_64)
LOCAL_C_INCLUDES := $(common_c_includes_64) $(ALSA_INCLUDES)
LOCAL_SHARED_LIBRARIES := libc libdl libcutils libjackserver libasound
LOCAL_MODULE_RELATIVE_PATH := jack
LOCAL_MODULE_TAGS := eng optional
LOCAL_MODULE := jack_alsa
...
# ========================================================
# jack_goldfish.so - Goldfish driver for emulator 64bit
# ========================================================
include $(CLEAR_VARS)
...
# ========================================================
# jack_opensles.so - OpenSL ES driver 64bit
# ========================================================
include $(CLEAR_VARS)
...
LOCAL_CPPFLAGS := $(common_cppflags)
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS_64)
LOCAL_C_INCLUDES := $(common_c_includes_64) frameworks/wilhelm/include
LOCAL_SHARED_LIBRARIES := libc libdl libcutils libjackserver libOpenSLES
LOCAL_MODULE_RELATIVE_PATH := jack
LOCAL_MODULE_TAGS := eng optional
LOCAL_MODULE := jack_opensles
...
LOCAL_CPPFLAGS := $(common_cppflags) -fpermissive
ifeq ($(TARGET_ARCH), arm64)
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS_64)
LOCAL_C_INCLUDES := $(common_c_includes_64)
else
...
LOCAL_CFLAGS := $(common_cflags)
ifeq ($(TARGET_ARCH), arm64)
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS_64) -ldl
LOCAL_C_INCLUDES := $(common_c_includes_64)
else
LOCAL_LDFLAGS := $(common_ldflags) $(JACK_STL_LDFLAGS)
LOCAL_C_INCLUDES := $(common_c_includes)
...
LOCAL_CFLAGS := $(common_cflags)
ifeq ($(TARGET_ARCH), arm64)
LOCAL_LDFLAGS := $(common_ldflags) -ldl
LOCAL_C_INCLUDES := $(common_c_includes_64)
else
LOCAL_LDFLAGS := $(common_ldflags)
LOCAL_C_INCLUDES := $(common_c_includes)
