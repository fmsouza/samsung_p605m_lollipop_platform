...
#define G_DATALIST_GET_POINTER(datalist)						\
  ((GData*)(intptr_t)((gsize) (intptr_t) g_atomic_pointer_get (datalist) & ~(gsize) G_DATALIST_FLAGS_MASK))

#define G_DATALIST_SET_POINTER(datalist, pointer)       G_STMT_START {                  \
  gpointer _oldv, _newv;                                                                \
  do {                                                                                  \
    _oldv = g_atomic_pointer_get (datalist);                                            \
    _newv = (gpointer)(intptr_t)(((gsize)(intptr_t) _oldv & G_DATALIST_FLAGS_MASK) | (gsize)(intptr_t) pointer);     \
		      ...
		      guint   flags)
{
  ...
  while (!g_atomic_pointer_compare_and_exchange ((void**) datalist, oldvalue,
                                                 (gpointer)(intptr_t) ((gsize)(intptr_t) oldvalue | flags)));
}
			...
			guint   flags)
{
  ...
  while (!g_atomic_pointer_compare_and_exchange ((void**) datalist, oldvalue,
                                                 (gpointer)(intptr_t)((gsize)(intptr_t) oldvalue & ~(gsize) flags)));
}
