...
g_once_init_enter_impl (volatile gsize *value_location)
{
  ...
  g_mutex_lock (g_once_mutex);
  if (g_atomic_pointer_get ((volatile gpointer *)value_location) == NULL)
    {
...
{
  g_return_if_fail (g_atomic_pointer_get ((volatile gpointer *)value_location) == NULL);
  g_return_if_fail (initialization_value != 0);
  g_return_if_fail (g_once_init_list != NULL);

  g_atomic_pointer_set ((void**)value_location, (void*)(intptr_t)initialization_value);
  g_mutex_lock (g_once_mutex);
